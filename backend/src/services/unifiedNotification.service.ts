...
const DEFAULT_BODIES: Record<NotificationEvent, { subject: string; body: string }> = {
  ...
  leave_submitted: {
    ...
    body: "Dear {name},\n\nA leave request requires attention.\n\nSM Travels International",
  },
  leave_approved: {
  ...
  attendance_correction: {
    ...
    body: "Dear {name},\n\nAn attendance correction requires attention.\n\nSM Travels International",
  },
  birthday_reminder: {
    subject: "Upcoming birthday",
    body: "Dear {name},\n\nReminder: an employee birthday is coming up.\n\nSM Travels International",
  },
  confirmation_reminder: {
    subject: "Confirmation due",
    body: "Dear {name},\n\nAn employee confirmation date is approaching.\n\nSM Travels International",
  },
  document_expiring: {
    subject: "Document expiring soon",
    body: "Dear {name},\n\nAn employee document is expiring soon.\n\nSM Travels International",
  },
  new_employee: {
