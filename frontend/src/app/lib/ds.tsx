...
const EMPTY_CFG: Record<EmptyVariant, {
  ...
  "no-data":       { icon: Inbox,       title: "Nothing here yet",         desc: "Add your first item to get started.",                color: "#1B75BC", bg: "#EEF2FF" },
  ...
  "coming-soon":   { icon: Package,     title: "Coming soon",               desc: "This section is under construction.",                color: "#F15A24", bg: "#FFF9E6" },
};
