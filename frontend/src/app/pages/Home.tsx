          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                ...
                {hero ? hpick(hero.secondaryLabel, hero.secondaryLabelBn) : bn ? "আমাদের ভিডিও দেখুন" : "Watch Our Video"}
              </motion.button>
            </div>
          </motion.div>
        </div>
          ...
          <div className="flex items-end justify-between gap-4 mb-8">
            <div>
              <p className="text-[#1B75BC] text-xs font-bold uppercase tracking-[0.18em] mb-2">
                {secEyebrow("video", "Video Guides", "ভিডিও গাইড")}
              </p>
              <h2 className="text-2xl md:text-3xl font-bold text-[#002D62]">
                {secTitle("video", "Video Tutorials & Guides", "ভিডিও টিউটোরিয়াল ও গাইড")}
              </h2>
