  ...
  return (
    <>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#14356B]/95 to-[#14356B]/70" />
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="max-w-xl">
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-3">Company Profile</div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-3">Our Story</div>
            ...
            <div className="flex gap-6 mt-8">
              {[
                ...
                <div key={i.l} className="text-center">
                  <div className="text-2xl font-black text-[#14356B]">{i.n}</div>
      ...
      <section className="py-12 md:py-20 bg-[#F7F8FA]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-2">Our Foundation</div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-[900px] mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-2">Our Journey</div>
              ...
              {MILESTONES.map((m, i) => (
                <div key={m.year} className={cn("flex gap-6 items-start", i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse")}>
                  ...
                  <div className="relative z-10 flex-shrink-0">
                    <div className="w-12 h-12 rounded-full bg-[#14356B] text-white text-[11px] font-black flex items-center justify-center border-4 border-white shadow">
                      {m.year.slice(2)}
                    </div>
                  </div>
                  <div className="flex-1 bg-[#F7F8FA] rounded-[12px] p-4 border border-[#E5E7EB]">
                    <div className="text-[12px] font-black text-[#C9A227] mb-0.5">{m.year}</div>
      ...
      <section className="py-12 md:py-20 bg-[#F7F8FA]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-2">Certifications & Accreditations</div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            <div className="text-[#C9A227] text-[12px] font-bold uppercase tracking-widest mb-2">Our Leadership</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {TEAM.map(t => (
              <div key={t.name} className="bg-[#F7F8FA] rounded-2xl p-6 text-center border border-[#E5E7EB]">
                <div className="w-16 h-16 bg-[#14356B]/10 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black text-[#14356B]">
                  {t.name[0]}
                </div>
                <h3 className="text-[14px] font-bold text-[#111827] mb-1">{t.name}</h3>
                <div className="text-[12px] font-semibold text-[#14356B] mb-1">{t.role}</div>
      ...
      <section className="py-10 md:py-16 bg-[#14356B] text-white text-center">
        <div className="max-w-xl mx-auto px-4 md:px-6">
          <Star size={32} className="text-[#C9A227] mx-auto mb-4" fill="currentColor" />
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link to="/contact" className="px-6 py-3 bg-[#C9A227] text-[#14356B] font-bold rounded-[10px] text-sm hover:bg-[#B8911F] transition-colors">
              Contact Us
            </Link>
