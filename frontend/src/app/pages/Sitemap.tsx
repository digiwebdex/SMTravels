...
const ZONE_CFG: Record<ZoneKey, { bg: string; border: string; text: string; badge: string; dot: string; label: string }> = {
  ...
  erp:        { bg: "bg-blue-50",    border: "border-blue-200",   text: "text-blue-800",   badge: "bg-blue-100 text-blue-800",     dot: "bg-[#14356B]",   label: "ERP (Staff)" },
...
const ROLES_LEGEND = [
  ...
  { label: "Admin",          color: "#14356B", bg: "#EEF2FF" },
  { label: "Accountant",     color: "#0E7C66", bg: "#ECFDF5" },
  { label: "Sales Exec",     color: "#EA580C", bg: "#FFF7ED" },
  { label: "Hajj/Umrah Exec",color: "#C9A227", bg: "#FFF9E6" },
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center gap-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <Link to="/login" className="flex items-center gap-1.5 text-xs font-semibold text-white bg-[#14356B] px-3 py-2 rounded-xl hover:bg-[#0f2a56] transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Organic Website Visit", icon: Globe, color: "#C9A227", action: "Book Now → /book" },
                    { label: "WhatsApp Inquiry", icon: MessageSquare, color: "#25D366", action: "CRM Lead (manual)" },
                    { label: "Walk-in / Phone", icon: Users, color: "#14356B", action: "CRM Lead (manual)" },
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Hajj Package",     icon: Star,    color: "#C9A227", route: "/hajj" },
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Bank Transfer",      icon: Landmark,    color: "#14356B", desc: "BEFTN / NPSB / RTGS" },
                    ...
                    { label: "Agent Commission",   icon: TrendingUp,  color: "#C9A227", desc: "Auto-deducted on payment" },
                  ].map(pay => {
                    const Icon = pay.icon;
                    return (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  { from: "/login", label: "Login Screen", color: "#14356B" },
                  { from: null, label: "→ Role Select", color: "#374151" },
                ].concat(
                  [
                    { from: "/erp",        label: "Admin / Exec → /erp",         color: "#14356B" },
                  ...
                  <div key={i} className="flex items-center gap-2">
                    {item.from ? (
                      <Link to={item.from}
                        className="flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 border-slate-200 hover:border-[#14356B]/30 hover:shadow-sm transition-all bg-white group">
